 ...
 * Sending a message blocks until the agent finishes its turn and returns the full reply.
 */
@RestController
...
public class ChatController {
    ...
    public SendMessageResult sendMessage(@PathVariable Long id, @RequestBody SendMessageRequest request) {
        return chatAgentService.sendMessage(id, request.text());
    }
